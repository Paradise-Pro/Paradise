...
export default function TopBar({ avatar, name, onAppLaunch }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "1rem", position: "relative" }}>
        ...
        {showMenu && (
          ...
          >
            ...
            {/* Weather */}
            <div style={appIconStyle} onClick={() => { onAppLaunch("weather"); toggleMenu(); }}>
              <img src="/icons/weather.png" alt="Καιρός" style={imgStyle} />
              <div style={labelStyle}>Καιρός</div>
            </div>

            {/* Calendar */}
            <div style={appIconStyle} onClick={() => { onAppLaunch("calendar"); toggleMenu(); }}>
              <img src="/icons/calendar.png" alt="Ημερολόγιο" style={imgStyle} />
              <div style={labelStyle}>Ημερολόγιο</div>
            </div>

            {/* Logout */}
            <div style={appIconStyle} onClick={() => { toggleMenu(); signOut({ callbackUrl: "/" }); }}>
      ...
      {/* Right side - Clock */}
      <div onClick={() => onAppLaunch("calendar")} style={{ cursor: "pointer" }}>
        <ClockWithCalendar />
      </div>
    </div>
  );
