  ...
  return (
    <>
      ...
      >
        ...
        <footer style={{ position: "absolute", bottom: "20px", fontSize: "13px", color: "#aaa", display: "flex", gap: "8px", alignItems: "center" }}>
          ...
          <Link href="/legal" style={{ color: "#aaa", textDecoration: "none" }}>⚖️ Legal Notice</Link>
        </footer>
      </div>
    </>
  );
